            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
                    ...
                    <p className="text-3xl font-bold text-emerald-400">
                        {session.user.role === 'admin' ? 'Unlimited' : summary.availableBalance.toLocaleString('en-IN', {
                            style: 'currency',
                            currency: 'INR',
                ...
                {/* <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
                    <h2 className="text-lg font-semibold text-gray-300 mb-2">Unrealized P&L</h2>
                    <div>
                ...
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
                    ...
                    <div>
                        <p className={`text-3xl font-bold ${summary.realizedPnL >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                            {session.user.role === 'admin' ? 'NA' : `${summary.realizedPnL.toLocaleString('en-IN', {
                                style: 'currency',
                                currency: 'INR',
                                maximumFractionDigits: 2
                            })}`}
                    ...
                    <table className="min-w-full divide-y divide-gray-700">
                        <thead className="bg-gray-900/50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-300 uppercase tracking-wider">Last Traded Price</th>
